...
$cars = array("Volvo", "BMW", "Toyota");//Sebuah array menyimpan beberapa nilai dalam satu variabel tunggal(array panjang)
echo count($cars);//The count()Fungsi digunakan untuk mengembalikan panjang (jumlah elemen) array
