...
echo str_replace("world", "Dolly", "Hello world!");//echo adalah built-in printout menampilkan str_replace (fungsi menggantikan beberapa karakter dengan beberapa karakter lain dalam sebuah string.)
