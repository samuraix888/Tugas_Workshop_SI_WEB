...
$txt = "W3Schools.com";/*$txt adalah variabel dengan value string ="W3Scools.com"*/
echo "I love $txt!";/*echo adalah built-in printout menampilkan string  i love lalu di ikuti panggil variabel $txt */
