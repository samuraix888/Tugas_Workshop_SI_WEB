...
echo "<h2>" . $txt1 . "</h2>";/*echo adalah built-in printout menampilkan variabel string $txt1 dengan ukuran font h2*/
echo "Study PHP at " . $txt2 . "<br>";/*echo adalah built-in printout menampilkan variabel string $txt2 dengan ukuran font h2*/
echo $x + $y;/*echo adalah built-in printout menampilkan hasil perhitungan int variabel x + y*/
